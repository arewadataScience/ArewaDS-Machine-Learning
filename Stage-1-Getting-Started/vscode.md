...
1. [Data Science in Visual Studio Code](https://code.visualstudio.com/docs/datascience/overview)
2. [How to Set up VS Code for Data Science & AI](https://www.youtube.com/watch?v=zulGMYg0v6U)
