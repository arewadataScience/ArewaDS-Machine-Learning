...
| ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | --------- | ------ |
| Learn the basic concepts behind data science and its relationship with AI, machine learning, and big data.              | [Introduction to Data Science](1-Introduction/README.md)       | [Recording](https://youtu.be/saH0U9SEtwQ)     | [Shamsuddeen Muhammad](https://shmuhammadd.github.io) |
| Introduction to data classification and common data sources.                                                            | [Understanding Data Types](2-Working-With-Data/README.md)           | [Recording](https://youtu.be/BJ-gNbfrJjI)   | [Shamsuddeen Muhammad](https://shmuhammadd.github.io) |
| Numpy | [Numpy Notebook](https://github.com/arewadataScience/ArewaDS-Machine-Learning/blob/main/Notebookss/Numpy.ipynb) \| [numpy-100-exercise](https://github.com/arewadataScience/ArewaDS-Machine-Learning/blob/main/100_numpy_exercise.md)       | [Recording](https://youtu.be/wnd8W0A5VHI)    | [Lukman](https://lukmanaj.github.io) |
