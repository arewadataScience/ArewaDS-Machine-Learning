...
|            | Introduction to Regression: Get started with regression models using Python and Scikit-learn.                     | Regression                      | [Lesson](Machine-Learning/2-Regression/README.md)                                 | TBD       | Ibrahim   |
|            | North American Pumpkin Prices 🎃: Visualize and clean data; build linear, polynomial, and logistic regression models.  | Regression                      | [Lesson](Machine-Learning/2-Regression/README.md)                                 | TBD       | brahim    |
